<template id="searchJournal">
    <div class="searchLog" style="font-size: 14px;">
        ...
        <mt-field readonly label="服务类型" placeholder="请选择服务类型" v-model="customerType" @click.native='showCustomerType'>
        </mt-field>
...
export default {
    ...
    methods: {
        ...
        searchLogClick: function() {           //销售日志搜索条件
            ...
            var param = {
                operatorIds :this.LururenId,                //录入人
                customName : this.customer,                 //客户名称
                type  : this.customerTypeId,                //服务类型
                maintainIds :this.guWenId,                  //维护工程师
                maintainStartTimeStr : this.visitStart2,    //维护时间开始
                maintainEndTimeStr : this.visitEnd2,        //维护时间结束
                startTimeStr : this.inputStart,             //录入时间开始
                endTimeStr : this.inputEnd,                 //录入时间结束
            ...
            this.$router.push({ path: 'logDetail', query: param})
        },
        //--------------------------------------
