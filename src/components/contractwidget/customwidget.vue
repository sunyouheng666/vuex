    ...
    export default {
        ...
        methods: {
            loadMore() {
                ...
                axios.post(self.html_url + self.Apilist.selectContractCustomDevelopment, param).then(function(data) { 
